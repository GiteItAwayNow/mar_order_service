...
* SEND_ORDER_CHAT_MESSAGE: название topic для отравки данных заказа в чат клиенту при оформлении заказа. **Должно быть такое же значение, как и у аналогичной переменной клиента, отправляющего сообщение**
